    ...
    <header class="g s r vd ya cj" :class="{ 'hh sm _k dj bl ll' : stickyMenu }"
        ...
        <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
            <div class="vd to/4 tc wf yf">
                <a href="index.html">
                    <img class="om" src="other-images/logo-light.svg" alt="Logo Light" />
                    <img class="xc nm" src="other-images/logo-dark.svg" alt="Logo Dark" />
                </a>
                <!-- <a href="index.html">
                    <img class="xc nm" src="images/logo.png" alt="Logo" />
                    <span class="text-2xl font-semibold uppercase">Himapro SI UMK</span>
                </a> -->
                ...
                <div class="tc wf ig pb no">
                    <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
                        <label class="rc ab i">
                            ...
                            <img class="xc nm" src="other-images/icon-moon.svg" alt="Moon" />
                        </label>
                    </div>
                    ...
                    <a href="{{ route('dashboard.index') }}"
                        ...
                        class="lk gh dk rg tc wf xf _l gi hi uppercase">Masuk ke dashboard</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <main>
        ...
        <section class="gj do ir hj sp jr i pg">
            ...
            <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
                ...
                <img src="other-images/hero.png" alt="Woman" class="h q r ua" />
            </div>
                ...
                <div class="tc uf zo xf ap zf bp mq">
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg mh">
                            <img src="other-images/icon-01.svg" alt="Icon" />
                        </div>
                        <div>
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg nh">
                            <img src="other-images/icon-02.svg" alt="Icon" />
                        </div>
                        <div>
                    ...
                    <div class="animate_top kn to/3 tc cg oq">
                        <div class="tc wf xf cf ae cd rg oh">
                            <img src="other-images/icon-03.svg" alt="Icon" />
                        </div>
                        <div>
            ...
            <div class="bb ze ki xn wq">
                <div class="tc wf gg qq">
                    ...
                    <div class="animate_left xc gn gg jn/2 i">
                        <div>
                            <img src="other-images/shape-05.svg" alt="Shape" class="h -ud-left-5 x" />
                            <img src="other-images/about-01.png" alt="About" class="ib" />
                            <img src="other-images/about-02.png" alt="About" />
                        </div>
                        <div>
                            <img src="other-images/shape-06.svg" alt="Shape" />
                            <img src="other-images/about-03.png" alt="About" class="ob gb" />
                            <img src="other-images/shape-07.svg" alt="Shape" class="bb" />
                        </div>
                    </div>
                    ...
                    <div class="animate_right jn/2">
                        ...
                        <a href="https://www.youtube.com/watch?v=xcJtL7QggTI" data-fslightbox class="vc wf hg mb">
                            <span class="tc wf xf be dd rg i gh ua">
                                ...
                                <img src="other-images/icon-play.svg" alt="Play" />
                            </span>
                ...
                <div class="wc qf pn xo gg cp">
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="other-images/team-01.png" alt="Team" />
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="other-images/team-02.png" alt="Team" />
                    ...
                    <div class="animate_top rj">
                        <div class="c i pg z-1">
                            <img class="vd" src="other-images/team-03.png" alt="Team" />
            ...
            <div class="bb ze ki xn yq mb en">
                <div class="wc qf pn xo ng">
                    ...
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="other-images/icon-04.svg" alt="Icon" />
                    ...
                    <!-- Service Item -->
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="other-images/icon-05.svg" alt="Icon" />
                    ...
                    <!-- Service Item -->
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="other-images/icon-06.svg" alt="Icon" />
                    ...
                    <!-- Service Item -->
                    <div class="animate_top sg oi pi zq ml il am cn _m">
                        <img src="other-images/icon-07.svg" alt="Icon" />
                ...
                <div class="projects-wrapper tc -ud-mx-5">
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="other-images/project-01.png" alt="Project" />
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 digital">
                        <div class="c i pg sg z-1">
                            <img src="other-images/project-02.png" alt="Project" />
                    ...
                    <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="other-images/project-04.png" alt="Project" />
                    ...
                    <div class="project-item wi fb vd vo/3 digital ecommerce">
                        <div class="c i pg sg z-1">
                            <img src="other-images/project-03.png" alt="Project" />
                            ...
                            <div class="swiper-slide">
                                <div class="i hh rm sg vk xm bi qj">
                                    ...
                                    <div class="tc sf rn tn un zf dp">
                                        <img class="bf" src="other-images/testimonial.png" alt="User" />

                                        <div>
                                            <img src="other-images/icon-quote.svg" alt="Quote" />
                                            ...
                                            <div class="tc yf vf">
                                                ...
                                                <img class="rk" src="other-images/brand-light-02.svg" alt="Brand" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="i pg qh rm ji hp">
            <img src="other-images/shape-11.svg" alt="Shape" class="of h ga ha ke" />
            <img src="other-images/shape-07.svg" alt="Shape" class="h ia o ae jf" />
            <img src="other-images/shape-14.svg" alt="Shape" class="h ja ka" />
            <img src="other-images/shape-15.svg" alt="Shape" class="h q p" />
            ...
            <div class="bb ze ah ch pm hj xp ki xn 2xl:ud-px-49 bc">
                <div class="wc rf qn zf cp kq xf wf">
                    <a href="#" class="rc animate_top">
                        <img class="th wl ml il zl om" src="other-images/brand-light-01.svg" alt="Clients" />
                        <img class="xc sk ml il zl nm" src="other-images/brand-dark-01.svg" alt="Clients" />
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="other-images/brand-light-02.svg" alt="Clients" />
                        <img class="xc sk ml il zl nm" src="other-images/brand-dark-02.svg" alt="Clients" />
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="other-images/brand-light-03.svg" alt="Clients" />
                        <img class="xc sk ml il zl nm" src="other-images/brand-dark-03.svg" alt="Clients" />
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="other-images/brand-light-04.svg" alt="Clients" />
                        <img class="xc sk ml il zl nm" src="other-images/brand-dark-04.svg" alt="Clients" />
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="other-images/brand-light-05.svg" alt="Clients" />
                        <img class="xc sk ml il zl nm" src="other-images/brand-dark-05.svg" alt="Clients" />
                    </a>
                    <a href="#" class="rc animate_top">
                        <img class="tk ml il zl om" src="other-images/brand-light-06.svg" alt="Clients" />
                        <img class="xc sk ml il zl nm" src="other-images/brand-dark-06.svg" alt="Clients" />
                    </a>
                </div>
            </div>
        </section>
                ...
                <div class="wc qf pn xo zf iq">
                    ...
                    <div class="animate_top sg vk rm xm">
                        <div class="c rc i z-1 pg">
                            <img class="w-full" src="other-images/blog-01.png" alt="Blog" />
                    ...
                    <div class="animate_top sg vk rm xm">
                        <div class="c rc i z-1 pg">
                            <img class="w-full" src="other-images/blog-02.png" alt="Blog" />
                    ...
                    <div class="animate_top sg vk rm xm">
                        <div class="c rc i z-1 pg">
                            <img class="w-full" src="other-images/blog-03.png" alt="Blog" />
            ...
            <div class="i va bb ye ki xn wq jb mo">
                <div class="tc uf sn tf rn un zf xl:gap-10">
                    <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
                        <!-- Bg Shapes -->
                        <img src="other-images/shape-03.svg" alt="Shape" class="h la x wd" />
                        <img src="other-images/shape-06.svg" alt="Shape" class="h la ma ne kf" />
        ...
        <section class="i pg gh ji">
            <!-- Bg Shape -->
            <img class="h p q" src="other-images/shape-16.svg" alt="Bg Shape" />
            ...
            <div class="ji gp">
                <div class="tc uf ap gg fp">
                    <div class="animate_top zd/2 to/4">
                        <a href="index.html">
                            <img src="other-images/logo-light.svg" alt="Logo" class="om" />
                            <img src="other-images/logo-dark.svg" alt="Logo" class="xc nm" />
                        </a>
