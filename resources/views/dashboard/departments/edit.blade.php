...
<div
    ...
    <form class="space-y-6" action="{{ route('departments.update', $department->id) }}" method="POST"
        ...
        <div>
            ...
            <input type="text" name="nama" id="nama"
                ...
                placeholder="Nama Departemen" value="{{ $department->nama }}" required />
        ...
        <div>
            ...
            <textarea id="detail" name="detail" rows="4"
                ...
                placeholder="Deskripsi Departemen">{{ $department->detail }}</textarea>
            <div class="my-2 text-sm text-red-600 dark:text-red-500">
        ...
        <div>
            <div>
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Icon
                    Departemen</label>
                <img src="/storage/{{ $department->icon }}" width="100px">
            </div>
            <input
