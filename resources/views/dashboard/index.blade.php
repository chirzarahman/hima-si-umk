...
<div
    ...
    <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white uppercase">Himapro si umk</h5>
    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Himpunan Mahasiswa Prodi Sistem Informasi
        Universitas Muria Kudus "we
        rise we change"</p>
</div>
