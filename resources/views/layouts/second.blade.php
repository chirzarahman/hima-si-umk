...
<body x-data="{ page: 'home', 'darkMode': true, 'stickyMenu': false, 'navigationOpen': false, 'scrollTop': false }"
        ...
        <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
            <div class="vd to/4 tc wf yf">
                <a href="/" class="flex items-center space-x-2">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo" class="om w-20" />
                    <span class="uppercase text-black font-semibold">Himapro si umk</span>
                </a>
                <!-- <a href="index.html">
            ...
            <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
                <nav>
                    <ul class="tc _o sf yo cg ep">
                        ...
                        <li><a href="/#teams" class="xl">Teams</a></li>
                        <li><a href="/#departments" class="xl">Departments</a></li>
                        <li><a href="/#events" class="xl">Events</a></li>
                        <li><a href="/#contacts" class="xl">Contacts</a></li>
                    </ul>
                </nav>
    ...
    <!-- ===== Footer Start ===== -->
    <footer>
        <div id="contacts" class="bb ze ki xn 2xl:ud-px-0">
            <!-- Footer Top -->
            <div class="ji gp">
                <div class="tc uf ap gg fp">
                    <div class="animate_top zd/2 to/4">
                        ...
                        <p class="lc fb">Jl. Lkr. Utara, Kayuapu Kulon, Gondangmanis, Kec. Bae, Kabupaten Kudus, Jawa
                            Tengah 59327</p>
                    ...
                    <div class="vd ro tc sf rn un gg vn">
                        <div class="animate_top">
                            ...
                            <ul>
                                ...
                                <li><a href="/#events" class="sc xl vb">Events</a></li>
                                <li><a href="/#contacts" class="sc xl vb">Contacts</a></li>
                            </ul>
                        </div>

                        <div>
                            <img src="{{ asset('images/image3.svg') }}" class="w-[40%]" />
                        </div>
            ...
            <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj">
                <div class="animate_top">
                    <ul class="tc wf gg">
                        <li><span class="xl">Chirza</span></li>
                        <li><span class="xl">Indra</span></li>
                        <li><span class="xl">Adi</span></li>
                        <li><span class="xl">Khoirul</span></li>
                        <li><span class="xl">Fajar</span></li>
                    </ul>
                </div>

                <div class="animate_top">
                    <p>&copy; 2025 Kelompok 1 A. Dibuat dengan penuh❤️</p>
                </div>
            </div>
            <!-- Footer Bottom -->
        </div>
